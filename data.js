const DATABASE = {
  news: [
    {
      ...
      content: "Полный текст новости будет здесь. VOEX NEWS запускает автоматический рейтинг команд по CS2. Система считает очки по результатам матчей и обновляет таблицу в реальном времени.",
      featured: true
    }
  ],
  ...
  teams: [
    ...
    },
    {
      ...
      achievements: [
        "3-4 place BLASTY OPEN WINTER",
        "2nd place BLASTY PRO LEAGUE 2",
        "3-4 place TABURETKA CUP",
        "3-4 place RAZE CUP SEASON 5"
      ],
  ...
  matches: [
    { id: 1, team1: "BlaiZ", team2: "White Team", score: "1:0", date: "10 АПР", format: "тех", maps: ["-"] },
    ...
    { id: 4, team1: "R8G", team2: "Burmalda", score: "1:0", date: "", format: "тех", maps: ["-"] },
    { id: 5, team1: "Phantom eSports", team2: "MVTeam", score: "2:0", date: "неизвестно", format: "BO3", maps: ["неизвестно"] },
    { id: 6, team1: "Ventus Axi", team2: "HYDRA eSports", score: "2:0", date: "13 АПР", format: "BO3", maps: ["неизвестно"] },
    { id: 7, team1: "Warm Ray Team", team2: "Phantom Academy", score: "2:0", date: "неизвестно", format: "BO3", maps: ["неизвестно"] },
    { id: 8, team1: "Lumen Novara", team2: "Burmalda", score: "1:0", date: "неизвестно", format: "BO3", maps: ["тех"] },
    { id: 9, team1: "Team Expoo", team2: "Burmalda", score: "1:0", date: "неизвестно", format: "BO3", maps: ["тех"] },
    { id: 10, team1: "Phantom eSports", team2: "Burmalda", score: "1:0", date: "неизвестно", format: "BO3", maps: ["тех"] },
    { id: 11, team1: "BCW TEAM", team2: "-", score: "1:0", date: "неизвестно", format: "BO3", maps: ["бонус"] },
    { id: 12, team1: "Blood Owners", team2: "BlaiZ", score: "2:0", date: "14 АПР", format: "BO3", maps: ["Overpass 13:8", "Inferno 13:5"] },
    { id: 13, team1: "SunCry", team2: "R8G", score: "0:2", date: "15 АПР", format: "BO3", maps: [""] },
    { id: 14, team1: "Ventus Axi", team2: "Phantom Academy", score: "1:0", date: "15 АПР", format: "BO3", maps: ["тех"] },
    { id: 15, team1: "Phantom eSports", team2: "BCW TEAM", score: "2:0", date: "17-21 АПР", format: "BO3", maps: ["-"] },
    { id: 16, team1: "WR Prodigy", team2: "Phantom eSports", score: "0:2", date: "11-14 АПР", format: "BO3", maps: ["-"] },
    { id: 17, team1: "MVTeam", team2: "-", score: "1:0", date: "неизвестно", format: "BO3", maps: ["бонус"] },
    { id: 18, team1: "MVTeam", team2: "Exot Team", score: "0:2", date: "16 АПР", format: "BO3", maps: ["Ancient 13-11", "Anubis 13-8"] },
    { id: 19, team1: "SunCry", team2: "Exot Team", score: "0:2", date: "18 АПР", format: "BO3", maps: [""] },
    { id: 20, team1: "HYDRA eSports", team2: "Warm Ray Team", score: "1:0", date: "-", format: "BO3", maps: ["тех"] },
    { id: 21, team1: "Ventus Axi", team2: "Warm Ray Team", score: "0:2", date: "21 АПР", format: "BO3", maps: [""] },
    { id: 22, team1: "Ventus Axi", team2: "Blood Owners", score: "2:0", date: "22 АПР", format: "BO3", maps: [""] },
    { id: 23, team1: "WR Prodigy", team2: "Exot Team", score: "0:2", date: "11-14 АПР", format: "BO3", maps: [""] },
    { id: 24, team1: "Lumen Novara", team2: "MVTeam", score: "0:2", date: "17-21 АПР", format: "BO3", maps: [""] },
    { id: 25, team1: "WR Prodigy", team2: "BlaiZ", score: "0:2", date: "17-21 АПР", format: "BO3", maps: [""] },
    { id: 26, team1: "HYDRA eSports", team2: "BlaiZ", score: "2:0", date: "21-25 АПР", format: "BO3", maps: [""] },
    { id: 27, team1: "HYDRA eSports", team2: "Phantom Academy", score: "2:0", date: "17-21 АПР", format: "BO3", maps: [""] },
    { id: 28, team1: "Warm Ray Team", team2: "SunCry", score: "0:2", date: "21-25 АПР", format: "BO3", maps: [""] },
    { id: 29, team1: "BCW TEAM", team2: "Team Expoo", score: "2:0", date: "21-25 АПР", format: "BO3", maps: [""] },
    { id: 30, team1: "Lumen Novara", team2: "WR Prodigy", score: "0:1", date: "21-25 АПР", format: "BO3", maps: ["тех"] },
    { id: 31, team1: "Exot Team", team2: "R8G", score: "1:0", date: "21-25 АПР", format: "BO3", maps: ["тех"] }
  ],
